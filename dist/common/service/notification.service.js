...
class NotificationService {
    client;
    constructor() {
        const serviceAccount = JSON.parse((0, node_fs_1.readFileSync)((0, node_path_1.resolve)(__dirname, "../../config/social-media-online-firebase-adminsdk-fbsvc-6fe2d44413.json")));
